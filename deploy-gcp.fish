...
# config
set project_id swagstudio   # <-- change this to your GCP project ID
...
echo ""
echo "📦 loading frontend/.env (if exists)..."
...
gcloud builds submit ./frontend --tag gcr.io/$project_id/frontend-app
